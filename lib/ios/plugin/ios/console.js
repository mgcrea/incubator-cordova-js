...
var stringify = function(message) {
    try {
        if (typeof message === "object" && JSON && JSON.stringify) {
            ...
            return message.toString().replace(/%((%)|s|o|d|b)/g, function (m) { return args[i++]; });
        }
    } catch (e) {
        return e.toString();
    }
...
DebugConsole.prototype.log = function(message) {
    if (this.logLevel <= DebugConsole.INFO_LEVEL) {
        exec(null, null, 'Debug Console', 'log', [ stringify.apply(this, arguments), { logLevel: 'INFO' } ]);
    }
...
DebugConsole.prototype.warn = function(message) {
    if (this.logLevel <= DebugConsole.WARN_LEVEL) {
        exec(null, null, 'Debug Console', 'log', [ stringify.apply(this, arguments), { logLevel: 'WARN' } ]);
    }
...
DebugConsole.prototype.error = function(message) {
    if (this.logLevel <= DebugConsole.ERROR_LEVEL) {
        exec(null, null, 'Debug Console', 'log', [ stringify.apply(this, arguments), { logLevel: 'ERROR' } ]);
    }
